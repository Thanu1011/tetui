...
import 'package:fluttertui_app/blocs_bot/sea_bloc.dart';

import 'package:logger/logger.dart';

class SeaWidgt extends StatefulWidget {
  SeaWidgt({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _SeaWidgtState createState() => _SeaWidgtState();
}

class _SeaWidgtState extends State<SeaWidgt> {
  final title1 = 'SEA - Surge Ensemble Agent';
  ...
  void _response(String mrRobot) async {
    ...
    if (_initConsult == true) {
      ...
      response = await _bloc.seaBusinessLogic(regUser, mrRobot);
    }
