...
import 'package:fluttertui_app/blocs_bot/qea_bloc.dart';

import 'package:logger/logger.dart';

class QeaWidgt extends StatefulWidget {
  QeaWidgt({Key key, this.title}) : super(key: key);
...
class _QeaWidgetState extends State<QeaWidgt> {
  final title1 = 'QEA - Quant Ensemble Agent';
  ...
  void _response(String mrRobot) async {
    ...
    if (_initConsult == true) {
      ...
      // Qea Business Logic moved to BLOC
      // Gotcha - remember to AWAIT everytime you call ASYNC Method
      response = await _bloc.qeaBusinessLogic(regUser, mrRobot);
    }
